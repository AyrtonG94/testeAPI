                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                ...
                                O Laravel tem uma documentação maravilhosa e completa cobrindo todos os aspectos do framework. Se você é novo no framework ou tem experiência anterior com Laravel, recomendamos a leitura de toda a documentação do começo ao fim.
                                </div>
                            </div>
                        </div>
